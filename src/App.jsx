...
import { Cloud, CloudRain, Sun, Wind, Droplets, Eye, Gauge, MapPin, Search, Clock, Star, Trash2, Calendar, CloudSnow } from 'lucide-react';
...
const WeatherApp = () => {
  ...
  const fetchWeather = async (lat, lon, locationName) => {
    ...
    try {
      ...
      const forecastData = data.daily.time.slice(1, 8).map((date, idx) => ({
